    ...
    _defineConverters() {
        ...
        conversion.for( 'editingDowncast' ).elementToElement( {
            ...
            view: ( modelElement, { writer: viewWriter } ) => {
                ...
                return toWidgetEditable( div, viewWriter );
                // let contentArticle = sessionStorage.getItem('articleContent')
                // if (contentArticle && temp) {
                //     const parser = new DOMParser();
                //     const doc = parser.parseFromString(contentArticle, 'text/html');
                //     const simpleGridCol1Elements = doc.getElementsByClassName('simpleGridCol1')
                //     console.log('col1 ' , simpleGridCol1Elements[i].style.flex, i)
                //     if (i == simpleGridCol1Elements.length - 1) {
                //         temp = false
                //     }
                //     if (simpleGridCol1Elements[i].style.flex == '1 1 0%') {
                //         const div = viewWriter.createEditableElement( 'div',
                //         {
                //             class: 'simpleGridCol1',
                //             style: 'flex: 1'
                ...
                //         i++
                //         return toWidgetEditable( div, viewWriter );
                //     } else if (simpleGridCol1Elements[i].style.flex == '2 1 0%;') {
                //         const div = viewWriter.createEditableElement( 'div',
                //         {
                //             class: 'simpleGridCol1',
                //             style: 'flex: 2'
        ...
        function renderDownCastElement() {
            ...
            return ( modelAttributeValue, { writer: viewWriter } ) => {
                ...
                console.log(document.getElementsByClassName('simpleGridCol2'))
                if(temp == false) {
                    i = 0
                    temp = true
                }
        ...
        conversion.for( 'editingDowncast' ).elementToElement( {
            ...
            view: ( modelElement, { writer: viewWriter } ) => {
                ...
                //sessionStorage.setItem('countForGrid', a++)
                return toWidgetEditable( div, viewWriter );
                // if ( sessionStorage.getItem('type') == 444)
                // {
                //     const div = viewWriter.createEditableElement( 'div',
                ...
                let contentArticle = sessionStorage.getItem('articleContent')
                if (contentArticle) {
                    if (sessionStorage.getItem('countForGrid')) {
                        sessionStorage.setItem('countForGrid',1)
                    }
                    else {
                        let a = sessionStorage.getItem('countForGrid')
                        a = parseInt(a)

                        const parser = new DOMParser();
                        const doc = parser.parseFromString(contentArticle, 'text/html');
                        const simpleGridCol2Elements = doc.getElementsByClassName('simpleGridCol2')

                        console.log('col2 ' , simpleGridCol2Elements[i].style.flex, i)

                        if (simpleGridCol2Elements[a].style.flex == '1 1 0%') {
                            const div = viewWriter.createEditableElement( 'div',
                            {
                                class: 'simpleGridCol2',
                                style: 'flex: 1'
                        ...
                        else if (simpleGridCol2Elements[a].style.flex == '2 1 0%;') {
                            const div = viewWriter.createEditableElement( 'div',
                            {
                                class: 'simpleGridCol2',
                                style: 'flex: 2'
                    ...
                    // if (simpleGridCol2Elements[i].style.flex == '1 1 0%') {
                    //     const div = viewWriter.createEditableElement( 'div',
                    //     {
                    //         class: 'simpleGridCol2',
                    //         style: 'flex: 1'
                    ...
                    //     return toWidgetEditable( div, viewWriter );
                    // }
                    // else if (simpleGridCol2Elements[i].style.flex == '2 1 0%;') {
                    //     const div = viewWriter.createEditableElement( 'div',
                    //     {
                    //         class: 'simpleGridCol2',
                    //         style: 'flex: 2'
